...
class Nankan::RaceCard < ApplicationRecord
  ...
  has_one :official_win, -> { order(crawled_at: :desc) }, class_name: 'Nankan::Win', foreign_key: :nankan_race_card_id
  has_one :official_place, -> { order(crawled_at: :desc) }, class_name: 'Nankan::Place', foreign_key: :nankan_race_card_id
