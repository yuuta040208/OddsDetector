...
class Api::External::V1::Nankan::OddsController < Api::External::V1::ApplicationController
  def win
    race = Nankan::Race.find_by!(description: params[:description], number: params[:number])
